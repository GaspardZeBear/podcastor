...
urls=[['A voix nue','http://radiofrance-podcast.net/podcast09/rss_10351.xml'],
      ...
      #['Mecanismes journalisme','https://radiofrance-podcast.net/podcast09/rss_21810.xml'],
      #['Anachronisme culturel','https://radiofrance-podcast.net/podcast09/rss_19724.xml'],
      ['Vertigo','https://www.rts.ch/la-1ere/programmes/vertigo/podcast/?flux=rss'],
      #['Tendances rtbf','http://rss.rtbf.be/media/rss/audio/lp-tendances_recent.xml'],
      ['Livres changent','https://radiofrance-podcast.net/podcast09/rss_22444.xml'],
      #['Rtbf','http://rss.rtbf.be/media/rss/audio/m3-couleur_recent.xml'],
      #['Voix est livre','https://www.europe1.fr/rss/podcasts/la-voix-est-livre.xml'],
      #['Meilleur mondes','https://radiofrance-podcast.net/podcast09/rss_22826.xml'],
      ['Etonner','https://radiofrance-podcast.net/podcast09/rss_22789.xml'],
      ['Fiction samedi','https://radiofrance-podcast.net/podcast09/rss_11496.xml'],
      #['Laisse parler hommes','https://radiofrance-podcast.net/podcast09/rss_22018.xml'],
      ['BookClub','https://radiofrance-podcast.net/podcast09/rss_12360.xml'],
      ['Pourquoi du comment','https://radiofrance-podcast.net/podcast09/rss_22831.xml'],
      ['Sans oser demander','https://radiofrance-podcast.net/podcast09/rss_15537.xml'],
      ['Heure philo','https://radiofrance-podcast.net/podcast09/rss_22676.xml'],
      ['Book club','https://radiofrance-podcast.net/podcast09/rss_23875.xml'],
      ['Haooiness lab ','https://omnycontent.com/d/playlist/e73c998e-6e60-432f-8610-ae210140c5b1/96C5C41E-0BC8-4661-B184-AE32006CD726/D623EF0B-3FEE-4C26-B815-AE32006CD739/podcast.rss'],
